...
const Cart = () => {
    const {cart,cartId,createOrGetCart,loading,updateCartItemQuantity,deleteCartItems} = useCartContext();
    ...
    const handleUpdateQuantity = async (itemId,newQuantity) =>{
        ...
        const prevLocalCartCopy = localCart //Store a copy of loaclCart
        ...
        try{
            ...
            console.log(error);
            setLocalCart(prevLocalCartCopy) //Rollback to previous state if API fails for network issue or other
        }
    }
    ...
    const handleRemoveItem = async(itemId) => {
      ...
      return { //item remove korle summar theke oi item er price komate
                ...prevLocalCart,
                items: updatedItems,
